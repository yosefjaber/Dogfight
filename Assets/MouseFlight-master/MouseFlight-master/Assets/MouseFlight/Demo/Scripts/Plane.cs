...
namespace MFlight.Demo
{
    ...
    public class Plane : MonoBehaviour
    {
        ...
        public float pitchMultipler = 100f;
        public float yawMultipler = 100f;
        public float rollMultipler = 100f;
        ...
        public void SetEnabledState(bool active)
        {
            isEnabled = active;
        }
