...
#region Serialized Fields
        ...
        [SerializeField]
        [Tooltip("Only render mirror for cameras with these names. Leave empty to render for all cameras.")]
        List<string> m_AllowedCameraNames = new List<string>();
#endregion
...
#region Constructors
        public Mirror()
        {
            ...
            m_AllowedCameraNames = new List<string>();
        }
#endregion
...
#region Properties
        ...
        /// <summary>List of camera names that are allowed to render this mirror.</summary>
        public List<string> allowedCameraNames
        {
            get => m_AllowedCameraNames;
            set => m_AllowedCameraNames = value;
        }
...
#region Rendering
        void BeginCameraRendering(ScriptableRenderContext context, Camera camera)
        {
            ...
            // Filter by camera name if list is not empty
            if(m_AllowedCameraNames != null && m_AllowedCameraNames.Count > 0)
            {
                bool isAllowed = false;
                foreach(string allowedName in m_AllowedCameraNames)
                {
                    if(camera.name == allowedName)
                    {
                        isAllowed = true;
                        break;
                    }
